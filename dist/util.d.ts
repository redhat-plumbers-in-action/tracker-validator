...
export declare function updateStatusCheck(context: Context<(typeof events.workflow_run)[number]>, checkID: number, status: 'in_progress' | 'completed', conclusion: 'success' | 'failure' | 'neutral' | 'cancelled' | 'timed_out' | 'action_required', message: string): Promise<import("@octokit/plugin-paginate-rest/dist-types/types").OctokitResponse<{
    id: number;
    head_sha: string;
    node_id: string;
